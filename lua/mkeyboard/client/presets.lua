...
MKeyboard:RegisterImpulseResponse( "#mkeyboard.ir.echo_bridge", "echo_bridge.wav" )
MKeyboard:RegisterImpulseResponse( "#mkeyboard.ir.square_victoria_dome", "square_victoria_dome.wav" )
